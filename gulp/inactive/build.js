 ...
 * ``
 * $ npm install gulp gulp-load-plugins gulp-filter gulp-rev gulp-rev-replace gulp-useref gulp-uglify gulp-plumber --save-dev
 * ``
 *
 ...
 * @return {Stream}
 */
gulp.task('build:compile',['clean-build'], function () {
